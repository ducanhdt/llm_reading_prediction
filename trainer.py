...
def train_model(config_path):
	...
	tokenized_dataset_test = dataset_test.map(tokenize_and_align_labels, batched=True, fn_kwargs={"tokenizer": model.tokenizer})
	...
	data_collator = DataCollatorForReadingTime(tokenizer=model.tokenizer, include_word_features=True)

	training_args = TrainingArguments(
		output_dir="./gemma-reading-time",
...
if __name__ == "__main__":
	import argparse
	parser = argparse.ArgumentParser(description="Train Gemma model for reading time prediction.")
